...
export const dictionary = {
  fr: {
    ...
    calculateur: {
      ...
      autoIndexButton: "Récupérer automatiquement",
      autoIndexComingSoon:
        "Bientôt disponible : la récupération automatique des indices INSEE ILC/ILAT/ICC est en cours de connexion à une source officielle vérifiée.",
    },
    clause: {
  ...
  en: {
    ...
    calculateur: {
      ...
      autoIndexButton: "Fetch automatically",
      autoIndexComingSoon:
        "Coming soon: automatic ILC/ILAT/ICC index lookup is being connected to a verified official source.",
    },
    clause: {

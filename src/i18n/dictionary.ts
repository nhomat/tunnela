...
export const dictionary = {
  fr: {
    ...
    pricing: {
      ...
      teaserSubtitle: "Choisissez le plan adapté à la taille de votre portefeuille.",
      teaserCta: "Comparer les plans en détail",
      ...
      compareOpenFull: "Ouvrir le comparateur détaillé",
    ...
    dashboard: {
      nav: {
        ...
        adminComptes: "Comptes",
        adminProspection: "Prospection",
        adminIndices: "Indices",
        adminJournal: "Journal d'activité",
    ...
    suspended: {
      ...
      body: "L'accès à ce compte a été temporairement suspendu. Contactez-nous si vous pensez qu'il s'agit d'une erreur.",
      contact: "Nous contacter",
    },
    conformite: {
      title: "Conformité à la réforme",
      subtitle: "D'où vient ce pourcentage, et comment le faire progresser.",
      noLeases: "Ajoutez des baux pour voir apparaître votre taux de conformité.",
      allCompliant: "Tous vos baux sont conformes à la réforme. Rien à faire pour l'instant.",
      howItWorksTitle: "Comment ce pourcentage est calculé",
      rule1: "Un bail utilisant l'indice ICC est toujours considéré non conforme : cet indice n'est plus autorisé pour les baux commerciaux depuis la réforme.",
      rule2: "Un bail utilisant l'indice ILC ou ILAT, avec une clause tunnel, est considéré conforme.",
      rule3: "Un bail utilisant l'indice ILC ou ILAT sans clause tunnel est classé « à vérifier » : l'indice est correct mais il manque la clause qui sécurise la révision.",
      formula: "Le pourcentage affiché = nombre de baux conformes ÷ nombre total de baux.",
      needsAttentionTitle: "Baux à corriger",
      why: {
        icc: "Indice ICC : changez d'indice (ILC ou ILAT).",
        noClause: "Il manque une clause tunnel pour sécuriser la révision.",
      },
      howToFix: "Comment l'améliorer",
      howToFixBody: "Modifiez le bail pour passer sur un indice ILC ou ILAT, puis ajoutez une clause tunnel — vous pouvez générer cette clause automatiquement depuis l'outil Clause & avenant.",
      goToClauseTool: "Générer une clause tunnel",
    },
    tutoriel: {
    ...
    equipe: {
      ...
      addonBenefit1: "Chaque collègue a son propre compte et son propre accès sécurisé.",
      addonBenefit2: "Messagerie d'équipe intégrée pour échanger sur un dossier en temps réel.",
      addonBenefit3: "Partage sélectif des baux : vous choisissez qui voit quoi.",
    ...
    admin: {
      ...
      overviewSubtitle: "Vue d'ensemble des comptes, abonnements et de la prospection commerciale.",
      notAllowed: "Réservé aux administrateurs.",
      totalUsers: "Comptes créés",
      activeUsers: "Abonnements actifs",
      totalBaux: "Baux enregistrés (tous comptes)",
      mrrEstimate: "MRR estimé",
      mrrEstimateHint: "Basé sur le plan de chaque compte actif, hors add-on Coop.",
      coopActive: "Équipes Coop actives",
      byPlan: "Répartition par plan",
      goToIndices: "Gérer les indices",
      goToIndicesHint: "Publier les valeurs ILC/ILAT/ICC de l'INSEE.",
      goToProspection: "Voir la prospection",
      goToProspectionHint: "Suivi de la campagne avocats & bailleurs.",
      backToAdmin: "← Administration",
      prospectionTitle: "Prospection commerciale",
      prospectionSubtitle: "État de la campagne de prospection avocats & bailleurs, synchronisé depuis Monday.com.",
      prospectionNotConfigured: "Monday.com n'est pas encore connecté.",
      prospectionNotConfiguredHint:
        "Ajoutez la variable d'environnement MONDAY_API_TOKEN (un jeton d'API personnel Monday.com, généré depuis Avatar > Administration > API) pour afficher les données de prospection ici.",
      prospectionError: "Impossible de récupérer les données de prospection.",
      totalContacts: "Contacts au total",
      contactedContacts: "Contactés",
      byType: "Répartition par type",
      byReponse: "Répartition des réponses",
      readyTitle: "Prêts à adhérer",
      readyEmpty: "Personne n'est encore marqué comme intéressé ou prêt à adhérer.",
      readyName: "Nom",
      readyEmail: "Email",
      readyPhone: "Téléphone",
      readyCompany: "Cabinet / Société",
      readyType: "Type",
      readyFeature: "Fonctionnalité(s) souhaitée(s)",
      readyStatus: "Statut",
      yes: "Oui",
      no: "Non",
      comptesTitle: "Comptes",
      comptesEmpty: "Aucun compte pour ce filtre.",
      comptesEmail: "Email",
      comptesPlan: "Plan",
      comptesStatut: "Statut",
      comptesCoop: "Coop actif",
      comptesAdmin: "Admin",
      comptesBaux: "Baux",
      comptesCreatedAt: "Créé le",
      comptesFilterAll: "Tous les comptes",
      comptesFilterActifs: "Abonnements actifs",
      comptesFilterPayants: "Comptes payants actifs",
      comptesFilterCoop: "Équipes Coop actives",
      comptesSearchPlaceholder: "Rechercher par email…",
      comptesExportCsv: "Exporter en CSV",
      equipeLabel: "Équipe",
      savePlan: "Enregistrer",
      grantAdmin: "Passer admin",
      revokeAdmin: "Retirer les droits admin",
      confirmGrantAdmin: "Donner les droits administrateur à ce compte ?",
      confirmRevokeAdmin: "Retirer les droits administrateur de ce compte ?",
      stripeCustomerLink: "Voir le client sur Stripe",
      stripeSubscriptionLink: "Voir l'abonnement sur Stripe",
      dangerZone: "Zone sensible",
      dangerZoneHint:
        "Le blocage et la suppression exigent un code de confirmation envoyé par email à tunnela.team@gmail.com et noa972971@gmail.com.",
      suspendAccount: "Bloquer temporairement",
      deleteAccount: "Supprimer le compte",
      reactivate: "Réactiver le compte",
      confirmReactivate: "Réactiver ce compte ?",
      confirmRequestSuspend: "Envoyer un code de confirmation par email pour bloquer ce compte ?",
      confirmRequestDelete: "Envoyer un code de confirmation par email pour supprimer ce compte ?",
      enterCodeHint:
        "Un code à 6 chiffres a été envoyé à tunnela.team@gmail.com et noa972971@gmail.com. Saisissez-le pour confirmer.",
      enterCodeMasterHint: "Ou saisissez directement le code secret défini à l'avance, sans attendre l'email.",
      confirmAction: "Confirmer",
      cancelAction: "Annuler",
      actionCodeError: "Impossible d'envoyer le code de confirmation.",
      actionCodeInvalid: "Code invalide ou expiré.",
      maintenanceTitle: "Mode maintenance",
      maintenanceSubtitle: "Affiche une page de maintenance à tous les clients (sauf les administrateurs connectés).",
      maintenanceActive: "Actuellement activé.",
      maintenanceInactive: "Actuellement désactivé.",
      maintenanceEnable: "Activer",
      maintenanceDisable: "Désactiver",
      maintenanceConfirmEnable: "Activer le mode maintenance pour tous les clients ?",
      maintenanceConfirmDisable: "Désactiver le mode maintenance ?",
      journalTitle: "Journal d'activité",
      journalSubtitle: "Historique des actions sensibles (blocage, suppression) demandées par les administrateurs.",
      journalEmpty: "Aucune action sensible pour l'instant.",
      journalDate: "Date",
      journalAdmin: "Administrateur",
      journalTarget: "Compte visé",
      journalAction: "Action",
      journalMethod: "Méthode",
      journalMethodEmail: "Code par email",
      journalMethodMasterCode: "Code secret",
      journalStatus: "Statut",
      journalStatusConfirmed: "Confirmée",
      journalStatusPending: "En attente de code",
      journalStatusExpired: "Expirée",
    },
    parametres: {
      title: "Paramètres",
      profilTitle: "Profil",
      ...
      passwordWrongCurrent: "Mot de passe actuel incorrect.",
  ...
  en: {
    ...
    pricing: {
      ...
      teaserSubtitle: "Choose the plan that fits the size of your portfolio.",
      teaserCta: "Compare plans in detail",
      ...
      compareOpenFull: "Open the detailed comparator",
    ...
    dashboard: {
      nav: {
        ...
        adminComptes: "Accounts",
        adminProspection: "Prospecting",
        adminIndices: "Indices",
        adminJournal: "Activity log",
        adminMaintenance: "Maintenance",
      },
    ...
    suspended: {
      ...
      body: "Access to this account has been temporarily suspended. Contact us if you think this is a mistake.",
      contact: "Contact us",
    },
    conformite: {
      title: "Compliance with the reform",
      subtitle: "Where this percentage comes from, and how to improve it.",
      noLeases: "Add leases to see your compliance rate appear.",
      allCompliant: "All your leases are compliant with the reform. Nothing to do for now.",
      howItWorksTitle: "How this percentage is calculated",
      rule1: "A lease using the ICC index is always considered non-compliant: this index is no longer allowed for commercial leases since the reform.",
      rule2: "A lease using the ILC or ILAT index, with a tunnel clause, is considered compliant.",
      rule3: "A lease using the ILC or ILAT index without a tunnel clause is marked \"to review\": the index is correct but the clause that secures the review is missing.",
      formula: "The percentage shown = number of compliant leases ÷ total number of leases.",
      needsAttentionTitle: "Leases to fix",
      why: {
        icc: "ICC index: switch to a different index (ILC or ILAT).",
        noClause: "A tunnel clause is missing to secure the review.",
      },
      howToFix: "How to improve it",
      howToFixBody: "Edit the lease to switch to the ILC or ILAT index, then add a tunnel clause — you can generate this clause automatically from the Clause & amendment tool.",
      goToClauseTool: "Generate a tunnel clause",
    },
    tutoriel: {
    ...
    equipe: {
      ...
      addonBenefit1: "Each colleague gets their own account and secure access.",
      addonBenefit2: "Built-in team messaging to discuss a file in real time.",
      addonBenefit3: "Selective sharing of leases: you choose who sees what.",
    ...
    admin: {
      ...
      overviewTitle: "Admin",
      overviewSubtitle: "Overview of accounts, subscriptions, and outbound prospecting.",
      notAllowed: "Admins only.",
      totalUsers: "Accounts created",
      activeUsers: "Active subscriptions",
      totalBaux: "Leases on file (all accounts)",
      mrrEstimate: "Estimated MRR",
      mrrEstimateHint: "Based on each active account's plan, excluding the Coop add-on.",
      coopActive: "Active Coop teams",
      byPlan: "Breakdown by plan",
      goToIndices: "Manage indices",
      goToIndicesHint: "Publish INSEE's ILC/ILAT/ICC values.",
      goToProspection: "View prospecting",
      goToProspectionHint: "Lawyer & landlord outreach campaign status.",
      backToAdmin: "← Admin",
      prospectionTitle: "Outbound prospecting",
      prospectionSubtitle: "Lawyer & landlord outreach campaign status, synced from Monday.com.",
      prospectionNotConfigured: "Monday.com isn't connected yet.",
      prospectionNotConfiguredHint:
        "Add the MONDAY_API_TOKEN environment variable (a personal Monday.com API token, from Avatar > Administration > API) to show prospecting data here.",
      prospectionError: "Couldn't fetch prospecting data.",
      totalContacts: "Total contacts",
      contactedContacts: "Contacted",
      byType: "Breakdown by type",
      byReponse: "Breakdown by response",
      readyTitle: "Ready to sign up",
      readyEmpty: "No one is marked interested or ready to sign up yet.",
      readyName: "Name",
      readyEmail: "Email",
      readyPhone: "Phone",
      readyCompany: "Firm / Company",
      readyType: "Type",
      readyFeature: "Requested feature(s)",
      readyStatus: "Status",
      yes: "Yes",
      no: "No",
      comptesTitle: "Accounts",
      comptesEmpty: "No account matches this filter.",
      comptesEmail: "Email",
      comptesPlan: "Plan",
      comptesStatut: "Status",
      comptesCoop: "Coop active",
      comptesAdmin: "Admin",
      comptesBaux: "Leases",
      comptesCreatedAt: "Created",
      comptesFilterAll: "All accounts",
      comptesFilterActifs: "Active subscriptions",
      comptesFilterPayants: "Active paying accounts",
      comptesFilterCoop: "Active Coop teams",
      comptesSearchPlaceholder: "Search by email…",
      comptesExportCsv: "Export as CSV",
      equipeLabel: "Team",
      savePlan: "Save",
      grantAdmin: "Make admin",
      revokeAdmin: "Remove admin rights",
      confirmGrantAdmin: "Grant administrator rights to this account?",
      confirmRevokeAdmin: "Remove administrator rights from this account?",
      stripeCustomerLink: "View customer on Stripe",
      stripeSubscriptionLink: "View subscription on Stripe",
      dangerZone: "Danger zone",
      dangerZoneHint:
        "Suspending or deleting requires a confirmation code emailed to tunnela.team@gmail.com and noa972971@gmail.com.",
      suspendAccount: "Suspend temporarily",
      deleteAccount: "Delete account",
      reactivate: "Reactivate account",
      confirmReactivate: "Reactivate this account?",
      confirmRequestSuspend: "Send an email confirmation code to suspend this account?",
      confirmRequestDelete: "Send an email confirmation code to delete this account?",
      enterCodeHint: "A 6-digit code was sent to tunnela.team@gmail.com and noa972971@gmail.com. Enter it to confirm.",
      enterCodeMasterHint: "Or type the pre-shared secret code directly, without waiting for the email.",
      confirmAction: "Confirm",
      cancelAction: "Cancel",
      actionCodeError: "Could not send the confirmation code.",
      actionCodeInvalid: "Invalid or expired code.",
      maintenanceTitle: "Maintenance mode",
      maintenanceSubtitle: "Shows a maintenance page to all customers (except logged-in administrators).",
      maintenanceActive: "Currently enabled.",
      maintenanceInactive: "Currently disabled.",
      maintenanceEnable: "Enable",
      maintenanceDisable: "Disable",
      maintenanceConfirmEnable: "Enable maintenance mode for all customers?",
      maintenanceConfirmDisable: "Disable maintenance mode?",
      journalTitle: "Activity log",
      journalSubtitle: "History of sensitive actions (suspend, delete) requested by administrators.",
      journalEmpty: "No sensitive action yet.",
      journalDate: "Date",
      journalAdmin: "Administrator",
      journalTarget: "Target account",
      journalAction: "Action",
      journalMethod: "Method",
      journalMethodEmail: "Emailed code",
      journalMethodMasterCode: "Secret code",
      journalStatus: "Status",
      journalStatusConfirmed: "Confirmed",
      journalStatusPending: "Awaiting code",
      journalStatusExpired: "Expired",
    },
    parametres: {
      title: "Settings",
      profilTitle: "Profile",

...
export const dictionary = {
  fr: {
    ...
    baux: {
      ...
      importDropHint: "Colonnes attendues : preneur, adresse, loyer_annuel, indice (ILC/ILAT/ICC), clause_tunnel (oui/non), plancher_pct, plafond_pct, date_prochaine_revision (AAAA-MM-JJ)",
  ...
  en: {
    ...
    baux: {
      ...
      importDropHint: "Expected columns: preneur, adresse, loyer_annuel, indice (ILC/ILAT/ICC), clause_tunnel (oui/non), plancher_pct, plafond_pct, date_prochaine_revision (YYYY-MM-DD)",

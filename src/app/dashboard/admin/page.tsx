    ...
    <div className="tunnel-enter max-w-3xl">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Link
          ...
          className="card card-hover transition-base flex flex-col gap-1"
        >
          <span className="font-serif text-lg">{t.admin.goToIndices}</span>
          <span className="text-sm text-[var(--foreground)]/70">{t.admin.goToIndicesHint}</span>
        </Link>
        <Link
          href="/dashboard/admin/prospection"
          className="card card-hover transition-base flex flex-col gap-1"
        >
          <span className="font-serif text-lg">{t.admin.goToProspection}</span>
          <span className="text-sm text-[var(--foreground)]/70">{t.admin.goToProspectionHint}</span>
        </Link>
      </div>
    </div>
  );
